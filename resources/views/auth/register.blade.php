{{-- <div class="mon">
        ...
        Nom:<input type ="nom" placeholder="entrez votre nom"></label>
        <br>
        Prénom:<input type="prénom" placeholder="entrez votre email"></label>
    <br>
...
@section('content')
<h1 class="text-3xl text-green-500 mb-6 text-center">Veuillez remplir tous les champs</h1>
<form method="POST" action="{{ route('register') }}" class="w-full max-w-sm mx-auto rounded-lg border shadow-md p-5 mb-5">
    ...
    <div class="mb-4">
        ...
        <input id="password_confirmation" type="password" name="password_confirmation" class="shadow border rounded w-full p-2" value="{{ old('password_confirmation') }}" autocomplete="password_confirmation" placeholder="Confirmez votre mot de passe" autofocus>
    </div>

    <p for="role-select" class="font-semibold text-gray-700">Je veux être :</p>
    <div class="flex justify-between items-center">
        <label for="couturier">Couturier
